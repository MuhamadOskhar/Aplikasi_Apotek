...
public class Frame_utama extends javax.swing.JDialog {
    ...
    private void saveDataToDatabase() {
        try {
            ...
            if (jTextField1.getText().isEmpty() || jTextField2.getText().isEmpty()
                ...
                JOptionPane.showMessageDialog(this, "Semua kolom harus diisi", "Input Error",
            ...
            try (Connection connection = koneksi.getConnection()) {
                ...
                try (PreparedStatement preparedStatement = connection.prepareStatement(query)) {
                    ...
                    if (rowsAffected > 0) {
                        ...
                        JOptionPane.showMessageDialog(this, "Gagal menyimpan data", "Database Error",
                                JOptionPane.ERROR_MESSAGE);
                    }
                }
            }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(
                new javax.swing.ImageIcon("/home/oskhar/server/myApp/Aplikasi_Apotek/img/netbeans/logo_puskes.jpg")); // NOI18N
        ...
        jLabel8.setIcon(
                new javax.swing.ImageIcon("/home/oskhar/server/myApp/Aplikasi_Apotek/img/netbeans/medshop_icon.png")); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(jTextField4, javax.swing.GroupLayout.PREFERRED_SIZE, 302,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jTextField1, javax.swing.GroupLayout.PREFERRED_SIZE, 302,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jTextField2, javax.swing.GroupLayout.PREFERRED_SIZE, 302,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jTextField3, javax.swing.GroupLayout.PREFERRED_SIZE, 302,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jTextField5, javax.swing.GroupLayout.PREFERRED_SIZE, 302,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(23, 23, 23)));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frame_utama.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
